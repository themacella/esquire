...
Geçen Zaman: \`${moment.duration(bitisSuresi-lobiID.Date).format("H [saat] m [dakika] s [saniye]")}\`
...
Geçen Zaman: \`${moment.duration(bitisSuresi2-lobiler.Date).format("H [saat] m [dakika] s [saniye]")}\`
