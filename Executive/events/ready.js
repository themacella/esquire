...
module.exports = async client => {
  ...
  if (data) return;
  if (!data) return console.log("Sunucu ayarları başarıyla yüklendi! artık kurulum yapabilirsiniz!"),await sunucuayar.updateOne({guildID: client.ayarlar.sunucuId}, {guildID: client.ayarlar.sunucuId}, {upsert: true, setDefaultsOnInsert: true}).exec();
